...
class KegeratorForm(FlaskForm):
    ...
    volume_of_keg = FloatField('Starting Volume of Kegerator (in fl oz)', validators=[DataRequired(),positive_field_check])
    volume_of_drink = FloatField('Volume of Drink (in fl oz)', validators=[DataRequired(),positive_field_check])
    ...
    #def __init__(self, *args, **kwargs):
            ...
            #self.end_time_day.data = datetime.datetime.now().time()
